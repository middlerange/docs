...
<CardGroup cols={2}>
  <Card title="Explore Zapier APIs" icon="plug" href="/api-reference/zapier/subscribe">
    Set up webhooks and real-time integrations
  </Card>
  <Card title="Public Widget APIs" icon="window" href="/api-reference/public/subscriber-identify">
    Build embedded feedback widgets
  </Card>
  <Card title="Admin APIs" icon="user-shield" href="/api-reference/admin/feedback-create">
...
- Check out our [full API reference](/api-reference/zapier/subscribe)
