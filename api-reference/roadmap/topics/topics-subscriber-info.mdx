...
```bash cURL
curl --location --request POST 'https://api.yourapp.com/v1/public/topics-subscriber.info' \
...
```javascript Node.js
const response = await fetch('https://api.yourapp.com/v1/public/topics-subscriber.info', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.yourapp.com/v1/public/topics-subscriber.info',
    headers={
